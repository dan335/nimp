...
import TriadColorsProperties from './TriadColorsProperties.jsx';
...
export default class TriadColors extends NodeColor {
  constructor(className, graph, x, y, settings) {
    ...
    this.outputs = [
      new OutputColor(this, 0, 'Triad 1'),
      new OutputColor(this, 1, 'Triad 2'),
      new OutputColor(this, 2, 'Triad 3'),
    ];
  }
