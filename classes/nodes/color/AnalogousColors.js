...
import AnalogousColorsProperties from './AnalogousColorsProperties.jsx';
...
export default class AnalogousColors extends NodeColor {
  constructor(className, graph, x, y, settings) {
    ...
    this.outputs = [
      new OutputColor(this, 0, 'Analogous 1'),
      new OutputColor(this, 1, 'Analogous 2'),
      new OutputColor(this, 2, 'Analogous 3'),
      new OutputColor(this, 3, 'Analogous 4'),
      new OutputColor(this, 4, 'Analogous 5'),
      new OutputColor(this, 5, 'Analogous 6'),
    ];
  }
  ...
  run(inputThatTriggered) {
    ...
    if (this.inputs[0].color) {
      ...
      this.colors = this.color.analogous();
