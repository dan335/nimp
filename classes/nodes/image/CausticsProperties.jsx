...
export default class CausticsProperties extends Properties {

  render() {
    return (
      <div>
        <div className="propertiesTitle">Caustics</div>
        <div style={{padding:'10px'}}>
          ...
          <PropertiesInputNumber node={this.props.node} name="Intensity" varName={'intensity'} input={this.props.node.inputs[4]} min={0} step={0.1} />
          {this.renderRun()}
        </div>
      </div>
    )
