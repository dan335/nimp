...
export default class CheckerProperties extends Properties {

  render() {
    return (
      <div>
        <div className="propertiesTitle">Checker</div>
        <div style={{padding:'10px'}}>
          ...
          <PropertiesInputNumber node={this.props.node} name="Size" varName={'size'} input={this.props.node.inputs[2]} min={1} step={1} />
          {this.renderRun()}
        </div>
      </div>
    )
