...
import Worley from '../classes/nodes/image/Worley.js';
// Phase 1 - Filters
import Threshold from '../classes/nodes/filter/Threshold.js';
import Sharpen from '../classes/nodes/filter/Sharpen.js';
import Emboss from '../classes/nodes/filter/Emboss.js';
import EdgeDetect from '../classes/nodes/filter/EdgeDetect.js';
import GradientMap from '../classes/nodes/filter/GradientMap.js';
import Clamp from '../classes/nodes/filter/Clamp.js';
// Phase 1 - Transforms
import TileRepeat from '../classes/nodes/transform/TileRepeat.js';
import Mirror from '../classes/nodes/transform/Mirror.js';
import Skew from '../classes/nodes/transform/Skew.js';
import Spherize from '../classes/nodes/transform/Spherize.js';
// Phase 1 - Generators
import Checker from '../classes/nodes/image/Checker.js';
import FBM from '../classes/nodes/image/FBM.js';
import BrickPattern from '../classes/nodes/image/BrickPattern.js';
// Phase 1 - Adjustments
import AutoLevels from '../classes/nodes/adjustment/AutoLevels.js';
// Phase 2 - Filters
import DirectionalBlur from '../classes/nodes/filter/DirectionalBlur.js';
import SlopeBlur from '../classes/nodes/filter/SlopeBlur.js';
import Warp from '../classes/nodes/filter/Warp.js';
import Curvature from '../classes/nodes/filter/Curvature.js';
import HistogramEqualize from '../classes/nodes/filter/HistogramEqualize.js';
// Phase 2 - Transforms
import Swirl from '../classes/nodes/transform/Swirl.js';
import Kaleidoscope from '../classes/nodes/transform/Kaleidoscope.js';
import MakeTileable from '../classes/nodes/transform/MakeTileable.js';
import PolarCoordinates from '../classes/nodes/transform/PolarCoordinates.js';
// Phase 2 - Generators
import HexagonGrid from '../classes/nodes/image/HexagonGrid.js';
import Scratches from '../classes/nodes/image/Scratches.js';

// Phase 3 - PBR Filters
import NormalBlend from '../classes/nodes/filter/NormalBlend.js';
import NormalToHeight from '../classes/nodes/filter/NormalToHeight.js';
import CurvatureFromNormal from '../classes/nodes/filter/CurvatureFromNormal.js';
import Bevel from '../classes/nodes/filter/Bevel.js';
import HeightBlend from '../classes/nodes/filter/HeightBlend.js';
// Phase 3 - PBR Outputs
import PBROutput from '../classes/nodes/filter/PBROutput.js';
import PBRPreview from '../classes/nodes/filter/PBRPreview.js';
// Phase 3 - Generators
import TileGenerator from '../classes/nodes/image/TileGenerator.js';
import WeavePattern from '../classes/nodes/image/WeavePattern.js';
import FiberPattern from '../classes/nodes/image/FiberPattern.js';
// Phase 4 - Utility
import ConvolutionCustom from '../classes/nodes/filter/ConvolutionCustom.js';
import ColorSpace from '../classes/nodes/filter/ColorSpace.js';
import DistanceField from '../classes/nodes/filter/DistanceField.js';
// Phase 4 - Transforms
import Perspective from '../classes/nodes/transform/Perspective.js';
import ContentAwareScale from '../classes/nodes/transform/ContentAwareScale.js';
// Phase 4 - Generators
import Caustics from '../classes/nodes/image/Caustics.js';
import CloudNoise from '../classes/nodes/image/CloudNoise.js';
// New Nodes - Phase 1: Quick Wins
import WhiteNoise from '../classes/nodes/image/WhiteNoise.js';
import GradientRadial from '../classes/nodes/image/GradientRadial.js';
import GradientAngular from '../classes/nodes/image/GradientAngular.js';
import HighPass from '../classes/nodes/filter/HighPass.js';
import Switch from '../classes/nodes/control/Switch.js';
import Vibrance from '../classes/nodes/adjustment/Vibrance.js';
// New Nodes - Phase 2: Core Tier 1
import Curves from '../classes/nodes/adjustment/Curves.js';
import ColorRangeSelect from '../classes/nodes/adjustment/ColorRangeSelect.js';
import MedianFilter from '../classes/nodes/filter/MedianFilter.js';
import MultiGradientMap from '../classes/nodes/filter/MultiGradientMap.js';
import Histogram from '../classes/nodes/filter/Histogram.js';
import Voronoi from '../classes/nodes/image/Voronoi.js';
import Shape from '../classes/nodes/image/Shape.js';
// New Nodes - Phase 3: BilateralFilter
import BilateralFilter from '../classes/nodes/filter/BilateralFilter.js';
// New Nodes - Phase 4: Tier 2
import ChannelShuffle from '../classes/nodes/adjustment/ChannelShuffle.js';
import Quantize from '../classes/nodes/adjustment/Quantize.js';
import Gamma from '../classes/nodes/adjustment/Gamma.js';
import ChromaticAberration from '../classes/nodes/filter/ChromaticAberration.js';
import Vignette from '../classes/nodes/filter/Vignette.js';
import Halftone from '../classes/nodes/filter/Halftone.js';
import Crystallize from '../classes/nodes/filter/Crystallize.js';
import Glow from '../classes/nodes/filter/Glow.js';
import Padding from '../classes/nodes/transform/Padding.js';
import StarburstPattern from '../classes/nodes/image/StarburstPattern.js';
import Splatter from '../classes/nodes/image/Splatter.js';
import ClampNumber from '../classes/nodes/number/ClampNumber.js';
import Remap from '../classes/nodes/number/Remap.js';
import ColorToImage from '../classes/nodes/color/ColorToImage.js';
import TilePreview from '../classes/nodes/filter/TilePreview.js';
import Compare from '../classes/nodes/filter/Compare.js';
// New Nodes - Tier 3
import OilPainting from '../classes/nodes/filter/OilPainting.js';
import AnisotropicBlur from '../classes/nodes/filter/AnisotropicBlur.js';
import PerlinNoise from '../classes/nodes/image/PerlinNoise.js';
import GaborNoise from '../classes/nodes/image/GaborNoise.js';
  ...
  nodes: [
    ...
    },
    {
      ...
      nodes: [
        ...
        {title:'Worley Noise', classObject:Worley, className:'Worley'},
        {title:'Checker', classObject:Checker, className:'Checker'},
        {title:'FBM Noise', classObject:FBM, className:'FBM'},
        {title:'Brick Pattern', classObject:BrickPattern, className:'BrickPattern'},
        {title:'Hexagon Grid', classObject:HexagonGrid, className:'HexagonGrid'},
        {title:'Scratches', classObject:Scratches, className:'Scratches'},
        {title:'Tile Generator', classObject:TileGenerator, className:'TileGenerator'},
        {title:'Weave Pattern', classObject:WeavePattern, className:'WeavePattern'},
        {title:'Fiber Pattern', classObject:FiberPattern, className:'FiberPattern'},
        {title:'Caustics', classObject:Caustics, className:'Caustics'},
        {title:'Cloud Noise', classObject:CloudNoise, className:'CloudNoise'},
        {title:'White Noise', classObject:WhiteNoise, className:'WhiteNoise'},
        {title:'Gradient Radial', classObject:GradientRadial, className:'GradientRadial'},
        {title:'Gradient Angular', classObject:GradientAngular, className:'GradientAngular'},
        {title:'Voronoi', classObject:Voronoi, className:'Voronoi'},
        {title:'Shape', classObject:Shape, className:'Shape'},
        {title:'Starburst Pattern', classObject:StarburstPattern, className:'StarburstPattern'},
        {title:'Splatter', classObject:Splatter, className:'Splatter'},
        {title:'Perlin Noise', classObject:PerlinNoise, className:'PerlinNoise'},
        {title:'Gabor Noise', classObject:GaborNoise, className:'GaborNoise'},
      ]
    },
    {
      title: 'Adjustment',
      nodes: [
        ...
        {title:'Auto Levels', classObject:AutoLevels, className:'AutoLevels'},
        {title:'Vibrance', classObject:Vibrance, className:'Vibrance'},
        {title:'Curves', classObject:Curves, className:'Curves'},
        {title:'Color Range Select', classObject:ColorRangeSelect, className:'ColorRangeSelect'},
        {title:'Channel Shuffle', classObject:ChannelShuffle, className:'ChannelShuffle'},
        {title:'Quantize', classObject:Quantize, className:'Quantize'},
        {title:'Gamma', classObject:Gamma, className:'Gamma'},
      ]
    },
    {
      title: 'Alpha',
    ...
    },
    {
      ...
      nodes: [
        ...
        {title:'Threshold', classObject:Threshold, className:'Threshold'},
        {title:'Sharpen', classObject:Sharpen, className:'Sharpen'},
        {title:'Emboss', classObject:Emboss, className:'Emboss'},
        {title:'Edge Detect', classObject:EdgeDetect, className:'EdgeDetect'},
        {title:'Gradient Map', classObject:GradientMap, className:'GradientMap'},
        {title:'Clamp', classObject:Clamp, className:'Clamp'},
        {title:'Directional Blur', classObject:DirectionalBlur, className:'DirectionalBlur'},
        {title:'Slope Blur', classObject:SlopeBlur, className:'SlopeBlur'},
        {title:'Warp', classObject:Warp, className:'Warp'},
        {title:'Curvature', classObject:Curvature, className:'Curvature'},
        {title:'Histogram Equalize', classObject:HistogramEqualize, className:'HistogramEqualize'},
        {title:'Normal Blend', classObject:NormalBlend, className:'NormalBlend'},
        {title:'Normal to Height', classObject:NormalToHeight, className:'NormalToHeight'},
        {title:'Curvature from Normal', classObject:CurvatureFromNormal, className:'CurvatureFromNormal'},
        {title:'Bevel', classObject:Bevel, className:'Bevel'},
        {title:'Height Blend', classObject:HeightBlend, className:'HeightBlend'},
        {title:'PBR Output', classObject:PBROutput, className:'PBROutput'},
        {title:'PBR Preview', classObject:PBRPreview, className:'PBRPreview'},
        {title:'Custom Convolution', classObject:ConvolutionCustom, className:'ConvolutionCustom'},
        {title:'Color Space', classObject:ColorSpace, className:'ColorSpace'},
        {title:'Distance Field', classObject:DistanceField, className:'DistanceField'},
        {title:'High Pass', classObject:HighPass, className:'HighPass'},
        {title:'Median Filter', classObject:MedianFilter, className:'MedianFilter'},
        {title:'Multi Gradient Map', classObject:MultiGradientMap, className:'MultiGradientMap'},
        {title:'Histogram', classObject:Histogram, className:'Histogram'},
        {title:'Bilateral Filter', classObject:BilateralFilter, className:'BilateralFilter'},
        {title:'Chromatic Aberration', classObject:ChromaticAberration, className:'ChromaticAberration'},
        {title:'Vignette', classObject:Vignette, className:'Vignette'},
        {title:'Halftone', classObject:Halftone, className:'Halftone'},
        {title:'Crystallize', classObject:Crystallize, className:'Crystallize'},
        {title:'Glow', classObject:Glow, className:'Glow'},
        {title:'Tile Preview', classObject:TilePreview, className:'TilePreview'},
        {title:'Compare', classObject:Compare, className:'Compare'},
        {title:'Oil Painting', classObject:OilPainting, className:'OilPainting'},
        {title:'Anisotropic Blur', classObject:AnisotropicBlur, className:'AnisotropicBlur'},
      ]
    },
    {
      title: 'Transform',
      nodes: [
        ...
        {title:'Tile Repeat', classObject:TileRepeat, className:'TileRepeat'},
        {title:'Mirror', classObject:Mirror, className:'Mirror'},
        {title:'Skew', classObject:Skew, className:'Skew'},
        {title:'Spherize', classObject:Spherize, className:'Spherize'},
        {title:'Swirl', classObject:Swirl, className:'Swirl'},
        {title:'Kaleidoscope', classObject:Kaleidoscope, className:'Kaleidoscope'},
        {title:'Make Tileable', classObject:MakeTileable, className:'MakeTileable'},
        {title:'Polar Coordinates', classObject:PolarCoordinates, className:'PolarCoordinates'},
        {title:'Perspective', classObject:Perspective, className:'Perspective'},
        {title:'Content Aware Scale', classObject:ContentAwareScale, className:'ContentAwareScale'},
        {title:'Padding', classObject:Padding, className:'Padding'},
      ]
    },
    {
      title: 'Number',
      nodes: [
        ...
        {title:'Clamp Number', classObject:ClampNumber, className:'ClampNumber'},
        {title:'Remap', classObject:Remap, className:'Remap'},
      ]
    },
    {
      title: 'Color',
      nodes: [
        ...
        {title:'Color to Image', classObject:ColorToImage, className:'ColorToImage'},
      ]
    },
    {
      title: 'String',
    ...
    },
    {
      ...
      nodes: [
        ...
        {title:'Switch', classObject:Switch, className:'Switch'},
      ]
    }
  ]
}
